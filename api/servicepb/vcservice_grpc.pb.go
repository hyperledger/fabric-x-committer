...
type ValidationAndCommitServiceClient interface {
	...
	GetNextBlockNumberToCommit(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*LastCommittedBlock, error)
...
func (c *validationAndCommitServiceClient) GetNextBlockNumberToCommit(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*LastCommittedBlock, error) {
...
type ValidationAndCommitServiceServer interface {
	...
	GetNextBlockNumberToCommit(context.Context, *emptypb.Empty) (*LastCommittedBlock, error)
...
func (UnimplementedValidationAndCommitServiceServer) GetNextBlockNumberToCommit(context.Context, *emptypb.Empty) (*LastCommittedBlock, error) {
