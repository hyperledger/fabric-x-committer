...
const (
	...
	ValidationAndCommitService_DeleteDBCloneForSnapshot_FullMethodName     = "/servicepb.ValidationAndCommitService/DeleteDBCloneForSnapshot"
)
...
type ValidationAndCommitServiceClient interface {
	...
	// Drops the database clone of the snapshot named by tx_id and clears the clone name from
	// its _snapshot row, keeping the row itself.
...
func (c *validationAndCommitServiceClient) DeleteDBCloneForSnapshot(ctx context.Context, in *committerpb.DeleteDBCloneForSnapshotRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ValidationAndCommitService_DeleteDBCloneForSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ValidationAndCommitServiceServer interface {
	...
	// Drops the database clone of the snapshot named by tx_id and clears the clone name from
	// its _snapshot row, keeping the row itself.
	DeleteDBCloneForSnapshot(context.Context, *committerpb.DeleteDBCloneForSnapshotRequest) (*emptypb.Empty, error)
...
func (UnimplementedValidationAndCommitServiceServer) DeleteDBCloneForSnapshot(context.Context, *committerpb.DeleteDBCloneForSnapshotRequest) (*emptypb.Empty, error) {
...
func _ValidationAndCommitService_DeleteDBCloneForSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(committerpb.DeleteDBCloneForSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ValidationAndCommitServiceServer).DeleteDBCloneForSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ValidationAndCommitService_DeleteDBCloneForSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ValidationAndCommitServiceServer).DeleteDBCloneForSnapshot(ctx, req.(*committerpb.DeleteDBCloneForSnapshotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ValidationAndCommitService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ValidationAndCommitService_DeleteDBCloneForSnapshot_Handler,
		},
	},
