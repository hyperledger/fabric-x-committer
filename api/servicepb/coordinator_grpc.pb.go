...
const (
	...
	Coordinator_DeleteDBCloneForSnapshot_FullMethodName       = "/servicepb.Coordinator/DeleteDBCloneForSnapshot"
)
...
type CoordinatorClient interface {
	...
	// its _snapshot row. Admin-triggered: forwarded verbatim from the sidecar to a vcservice.
...
func (c *coordinatorClient) DeleteDBCloneForSnapshot(ctx context.Context, in *committerpb.DeleteDBCloneForSnapshotRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Coordinator_DeleteDBCloneForSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCoordinatorServer) DeleteDBCloneForSnapshot(context.Context, *committerpb.DeleteDBCloneForSnapshotRequest) (*emptypb.Empty, error) {
...
func _Coordinator_DeleteDBCloneForSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(committerpb.DeleteDBCloneForSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoordinatorServer).DeleteDBCloneForSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Coordinator_DeleteDBCloneForSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoordinatorServer).DeleteDBCloneForSnapshot(ctx, req.(*committerpb.DeleteDBCloneForSnapshotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Coordinator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Coordinator_DeleteDBCloneForSnapshot_Handler,
		},
	},
