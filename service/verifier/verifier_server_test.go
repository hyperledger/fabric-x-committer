...
func TestSignatureRule(t *testing.T) {
	...
	tx1.SignatureSets = []*protoblocktx.SignatureSet{
		test.CreateSignatureSetForSignatureRule(signatures, mspIDs, certsBytes),
	}
	...
	tx1.SignatureSets = []*protoblocktx.SignatureSet{
		test.CreateSignatureSetForSignatureRule(signatures[0:1], mspIDs[0:1], certsBytes[0:1]),
	}
