...
// newValidatedTxsFromPrepared is what the validator hands the committer for a batch whose
// writes all survived validation, so no status and no feedback are set.
