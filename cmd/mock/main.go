...
func startMockOrderer() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return servicelifecycle.StartAndServe(cmd.Context(), service, serverConfigs...)
		},
	}
...
func startMockCoordinator() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return servicelifecycle.Serve(cmd.Context(), service, conf.Server)
		},
	}
	cliutil.SetDefaultFlags(cmd, &configPath)
	return cmd
...
func startMockVerifier() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return servicelifecycle.Serve(cmd.Context(), sv, conf.Server)
		},
	}
	cliutil.SetDefaultFlags(cmd, &configPath)
	return cmd
...
func startMockVC() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return servicelifecycle.Serve(cmd.Context(), vcs, conf.Server)
		},
	}
	cliutil.SetDefaultFlags(cmd, &configPath)
	return cmd
