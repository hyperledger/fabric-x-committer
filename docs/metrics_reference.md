...
| coordinator_verifier_fetch_validated_txs_lock_wait_seconds                             | histogram |               | Time spent waiting to acquire the txBeingValidated lock while fetching validated transactions from a signature verifier. |
| coordinator_verifier_fetch_validated_txs_lock_hold_seconds                             | histogram |               | Time spent holding the txBeingValidated lock while fetching validated transactions from a signature verifier.            |
