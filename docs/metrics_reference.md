...
| sidecar_relay_checkpoint_feedback_state                    | gauge     |                                  | Checkpoint state: 0 = running, 1 = waiting for the local snapshot hash, 2 = stopped because the local and checkpoint hashes differ.                      |
| sidecar_relay_checkpoint_feedback_total                    | counter   | signal                           | Total number of checkpoint feedback signals received from the committer, by signal.                                                                      |
| sidecar_relay_block_pull_paused_seconds_total              | counter   |                                  | Total time spent in completed checkpoint hold waits, in seconds.                                                                                         |
| sidecar_relay_checkpoint_holds_total                       | counter   |                                  | Total number of checkpoint holds while waiting for the local snapshot hash. Includes repeated holds for the same checkpoint.                             |
